    ...
    return(
        <svg className={className} viewBox="-10 -10 230 230" fill="none" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
            <g filter="url(#filter0_d_914_264)">
                <path d="M108 0L198.067 53.75V161.25L108 215L17.9334 161.25V53.75L108 0Z" fill={"url(#pattern"+img+")"} shapeRendering="crispEdges"/>
                <path d="M19.9334 54.8855L108 2.32908L196.067 54.8855V160.114L108 212.671L19.9334 160.114V54.8855Z" stroke="#00ECFB" strokeWidth="4" shapeRendering="crispEdges"/>
                {linkTo ?
                    <path d="M19.9334 54.8855L108 2.32908L196.067 54.8855V160.114L108 212.671L19.9334 160.114V54.8855Z" fill="url(#paint0_linear_914_264)" fillOpacity="0.63" shapeRendering="crispEdges"/>
                :''}
            </g>
            <a href={linkTo}>
            ...
            <defs>
                <filter id="filter0_d_914_264" x="0.933357" y="-16" width="216.133" height="251" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
